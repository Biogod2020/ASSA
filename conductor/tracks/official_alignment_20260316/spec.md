...
- Complete rewrite of all Python scripts (only core TS/JS infrastructure will be prioritized initially).\n\n## Migration Note\nReference legacy code from  for logic ports.


## Migration Note
Reference legacy code from `../self_evolement` for logic ports.
