        ...
        result: {
          tools: [
            ...
            },
            {
              ...
              description:
                'Distills all PENDING ledger signals into patterns.md. This is a pure function—no LLM needed. Call this when you see PENDING items in L1 context.',
              inputSchema: {
                type: 'object',
                properties: {},
                required: [],
            ...
            },
            {
              ...
              description:
                'Requests the promotion of mature L2 patterns to the Global L3 Library. This tool triggers an AI-led synchronization process using the Syncer agent.',
              inputSchema: {
                type: 'object',
                properties: {
                  topic: {
                    type: 'string',
                    description:
                      'The domain/topic to focus on (e.g., ARCHITECTURE, PYTHON)',
                  },
                },
              },
            },
            {
              ...
              description:
                'Marks specific message IDs in the ledger as PROCESSED.',
              inputSchema: {
                type: 'object',
                properties: {
                  message_ids: {
            ...
            },
            {
              name: 'check_health',
              description:
                'Performs a comprehensive health check of the ASSA environment.',
              inputSchema: {
                type: 'object',
                properties: {},
                required: [],
